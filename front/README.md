...
Desde la raíz del repositorio, ejecutá el script del frontend. El script instala dependencias dentro de `front/` si hace falta y arranca Vite:

```powershell
.\front\scripts\start_app.ps1
```
...
```powershell
.\front\scripts\kill_dev_server.ps1
```
...
- [Especificación de Requerimientos Funcionales](docs/functional_requirements_specification.md)
- [Especificación Técnica de Puertos y Adaptadores](docs/technical_specification.md)
- [Guía de Despliegue en Producción (Cloudflare Pages + Firebase)](docs/DEPLOY_PROD.md)
- [Índice de Mocks de Interfaz de Referencia](docs/mocks/README.md)
