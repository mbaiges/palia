...
const DEFAULT_RESET: PasswordResetEmailTranslations = {
  tagline: 'A reusable application scaffold',
  resetTitle: 'Reset your password',
  resetClick: 'Click the button below to choose a new password:',
  resetButton: 'Reset password',
  linkExpires: 'This link expires in 1 hour.',
...
export interface PasswordResetEmailProps {
  resetUrl: string;
  logoUrl: string;
  translations?: Partial<PasswordResetEmailTranslations>;
}

export function PasswordResetEmail({ resetUrl, logoUrl, translations }: PasswordResetEmailProps) {
  const t = { ...DEFAULT_RESET, ...translations };
  return (
    <Html lang="en">
      <Head>
        <style>{`
