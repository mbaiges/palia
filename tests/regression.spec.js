...
test.describe('Palia Full App E2E Regression Suite', () => {
  ...
  test('should execute full clinical workflow (Login -> Create -> Follow-up -> Assign -> Verify -> Logout) on Desktop', async ({ page }) => {
    ...
    await page.selectOption('select[name="pain"]', '7-9 - Severo');
    await page.selectOption('select[name="nausea"]', 'Frecuente');
    await page.selectOption('select[name="dyspnea"]', 'Grado 2 - Moderada');
